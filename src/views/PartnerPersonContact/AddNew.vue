<template>
  ...
  >
    <template #default="{ hide }">
      ...
      >
        <h5 class="mb-0">{{ headerType }} Partner Contact</h5>
        ...
        >
          ...
          >
            <b-form-group label="Position" label-for="position">
              ...
              <span class="text-danger text-sm" v-if="allerrors.position">{{
                allerrors.position[0]
              }}</span>
            </b-form-group>
          </validation-provider>
...
export default {
  ...
  watch: {
    isAddNewUserSidebarActive(val) {
      ...
      if (Object.entries(this.dataSlider).length === 0) {
        ...
        this.position = this.dataSlider.position;
        this.partnerId = this.dataSlider.partnerId;
  ...
  methods: {
    initValues() {
      ...
      this.id = null;
      this.name = null;
      this.partnerId = this.partnerIdProp || null;
      this.phone = null;
      this.email = null;
      this.position = null;
      this.allerrors = [];
